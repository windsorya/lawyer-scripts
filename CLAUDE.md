...
---
## SEO 週報產出規則（2026-04-19 確立）
- SEO 週報一律存 **Notion**，在 SEO 主控台（ID: 344e22f2-1ca4-8149-a627-d9e378a6772a）下建子頁面
- 頁面標題格式：「📊 SEO 週報 YYYY-MM-DD」
- **禁止**存 Drive claude-handoff/ 的 .md 檔（Drive .md 檔 readGoogleDoc 讀不到，已確認根本性限制）
- 律師說「CC 跑完了」→ claude.ai 去 Notion SEO 主控台下找當週週報子頁
...
- 2026-04-19 SEO 週報輸出改為 Notion：週報存 SEO 主控台（344e22f2-1ca4-8149-a627-d9e378a6772a）子頁面，不再存 Drive claude-handoff/ .md；外接硬碟已同步路由規則（⏳待同步）
